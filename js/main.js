(function ($) {
   ...
   /* function initialiseGoogleMap() {
    ...
    $('.ace-icon-wechat,.ace-icon-qq,.ace-icon-mobile-phone,.ace-icon-weibo').mouseout(function(){
        $('#linkChange').remove();
    });

    $('.ace-icon-wechat').mouseover(function () {
        $('#ace-card .ace-card-footer').prepend('<div id="linkChange" ><img src="img/uploads/avatar/avatar-wechat.jpg" ></div>');
    });
    $('.ace-icon-qq').mouseover(function(){
            $('#ace-card .ace-card-footer').prepend('<div id="linkChange" ><img src="img/uploads/avatar/avatar-qq.jpg" ></div>');
        });
    $('.ace-icon-weibo').click(function(){
            $('#ace-card .ace-card-footer').prepend('<div id="linkChange" ><img src="img/uploads/avatar/avatar-weibo.jpg" ></div>');
        });
})(jQuery);
